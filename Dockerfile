...
LABEL \
    ...
    org.label-schema.name="Timmo" \
    org.label-schema.schema-version="1.0" \
    org.label-schema.url="https://timmo.dev/timmo" \
    org.label-schema.usage="https://github.com/timmo001/timmo/tree/master/README.md" \
    org.label-schema.vcs-ref=${BUILD_REF} \
    org.label-schema.vcs-url="https://github.com/timmo001/timmo" \
